...
async def main(wallet_name: str, log_file_path, log_file_name):
...
if __name__ == '__main__':
    if len(sys.argv) < 4:
        ...
        print("expected: wallet name, path to log file, and name of log file")
        print("If you are on a mac do...")
        print("export DYLD_LIBRARY_PATH=[path_to_folder_containing_libindy.dylib]:${DYLD_LIBRARY_PATH}")
        print("Usage: export DYLD_LIBRARY_PATH=/Users/norm/Home/.build_artifacts/libindy/master_6748627dcc42e9f3760411789f586d3c07b35138/target/x86_64-apple-darwin/release")
        print("Usage: python3 decrypt_logs.py LIBVCX_SDK_WALLET ~/Downloads kelly.testing.log.enc")
    ...
    loop.run_until_complete(main(wallet_name, logs_file_path, logs_file_name))
