...
public class CredentialTest extends IntSetup {
	...
	public void sendCredentialTest() throws Exception {
		...
		objAppUtlis.sendCredentialAndAccept(driver, connectionID, credentialDefID1, data,"0", false, false);
	}
	...
	public void sendMultipleCredentialTest1() throws Exception {
		...
		objAppUtlis.sendCredentialAndAccept(driver, connectionID, credentialDefID2, data,"0", false, false);
	}
