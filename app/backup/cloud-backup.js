  ...
  mainBody = () => {
    return (
      <View>
        ...
        >
          When enabled, any changes to your Connect.Me app are automatically
        ...
        <CustomView style={questionStyles.customViewHelperStyles}>
          <CustomText
            ...
            style={[{ color: color.bg.tertiary.font.seventh }]}
          >
            All Connect.Me backups are encrypted and anonymized before leaving
            your phone. You will still need your Recovery Phrase and a fresh
            install of Connect.Me to recover.
          </CustomText>
        </CustomView>
