...
describe('Test connections, credentials and proofs', () => {
  ...
  it('Case 1.2: create schemas and credential definitions', async () => {
    // // CLAIM_OFFER_PROFILE_INFO
  ...
  xit('Case 3.4: create and send self-attested proof request', async () => {
  ...
  it('Case 6: delete existing connection, credentials and tear down environment', async () => {
