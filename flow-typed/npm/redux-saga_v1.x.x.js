...
declare module 'redux-saga' {
  ...
  declare export var runSaga: {
    ...
    <
      ...
      T6,
      T7,
      Fn: (T1, T2, T3, T4, T5, T6, T7) => Saga<R>
    >(
      options: RunSagaOptions<A, S>,
      saga: Fn,
      T1,
    ...
    <
      ...
      T7,
      T8,
      Fn: (T1, T2, T3, T4, T5, T6, T7, T8) => Saga<R>
    >(
      options: RunSagaOptions<A, S>,
      saga: Fn,
      T1,
  ...
  declare export type SagaMiddleware<C: {}> = {
    ...
    run: {
      ...
      <R, T1, T2, T3, Fn: (T1, T2, T3) => Saga<R>>(
        saga: Fn,
        T1,
        T2,
        T3
      ): Task<R>,
      <R, T1, T2, T3, T4, Fn: (T1, T2, T3, T4) => Saga<R>>(
        saga: Fn,
        T1,
        T2,
        T3,
  ...
  declare export type JoinEffect<T: Task<*> | Array<Task<*>>> = IEffect<
    'JOIN',
    T,
    false
  >
  ...
  declare export type FlushEffect<CH: FlushableChannel<*>> = IEffect<
    'FLUSH',
    CH,
    false
  >
...
declare module 'redux-saga/effects' {
  ...
  declare export var cps: {
    ...
    <R, T1, Fn: (T1, NodeCallback<R>) => void>(
      Fn,
      T1
    ): CpsEffect<null, Fn, [T1]>,
    <R, T1, T2, Fn: (T1, T2, NodeCallback<R>) => void>(
      Fn,
      T1,
      T2
    ...
    <
      ...
      T5,
      T6,
      Fn: (T1, T2, T3, T4, T5, T6, NodeCallback<R>) => void
    >(
      Fn,
      T1,
      T2,
    ...
    <
      ...
      T6,
      T7,
      Fn: (T1, T2, T3, T4, T5, T6, T7, NodeCallback<R>) => void
    >(
      Fn,
      T1,
      T2,
    ...
    <
      ...
      T4,
      T5,
      Fn: (T1, T2, T3, T4, T5, NodeCallback<R>) => void
    >(
      cfn: [Ctx, Fn],
      T1,
      T2,
    ...
    // cps({context, fn}, ...args)
    <Ctx, R, Fn: (NodeCallback<R>) => void>(cfn: {
      context: Ctx,
      fn: Fn,
    }): CpsEffect<Ctx, Fn, []>,
    <Ctx, R, T1, Fn: (T1, NodeCallback<R>) => void>(
  ...
  declare export var fork: {
    ...
    // fork({context, fn}, ...args)
    <Ctx, R, Fn: () => R>(cfn: { context: Ctx, fn: Fn }): ForkEffect<
      Ctx,
      Fn,
      void,
      []
  ...
  declare export var spawn: {
    ...
    <R, T1, Fn: T1 => R>(
      Fn,
      T1
    ): ForkEffect<null, Fn, { detached: true }, [T1]>,
    <R, T1, T2, Fn: (T1, T2) => R>(
      Fn,
      T1,
      T2
    ...
    <Ctx, R, Fn: () => R>(
      cfn: [Ctx, Fn]
    ): ForkEffect<Ctx, Fn, { detached: true }, []>,
    <Ctx, R, T1, Fn: T1 => R>(
      cfn: [Ctx, Fn],
      T1
  ...
  declare export var select: {
    ...
    <S, R, T1, T2, Fn: (S, T1, T2) => R>(
      Fn,
      T1,
      T2
    ): SelectEffect<Fn, [T1, T2]>,
    <S, R, T1, T2, T3, Fn: (S, T1, T2, T3) => R>(
      Fn,
      T1,
      T2,
      T3
    ...
    <
      ...
      T7,
      T8,
      Fn: (S, T1, T2, T3, T4, T5, T6, T7, T8) => R
    >(
      Fn,
      T1,
      T2,
  ...
  declare export var take: {
    ...
    // take(channel)
    (): AllTakeEffect<void>,
    <T, CH: TakeableChannel<T>>(
      channel: CH
    ): TakeEffect<void, { channel: CH }, void>,
  ...
  declare export var takeMaybe: {
    ...
    <T, CH: TakeableChannel<T>>(
      channel: CH
    ): TakeEffect<void, { channel: CH }, { maybe: true }>,
  ...
  declare export var takeEvery: {
    ...
    <A, R, P: TakeableChannel<*> | Pattern, Fn: A => R>(
      P,
      Fn
    ): ForkEffect<null, Fn, void, [P, Fn]>,
  ...
  declare export var delay: {
    ...
    <T1: number, T2>(
      timeout: T1,
      T2
    ): CallEffect<null, (ms: T1) => Promise<true>, [T1, T2]>,
  }
